...
| WEST TERRACE | bay 1 x -492..-476 / z -502..-458 (done), bay 2 x -512..-496 / z -500..-460 (job `west_terrace_cut_2`), cut to y73 | dirt + stone source, job `west_terrace_cut`: a grass hill 80 blocks W of the wall (tops y76-86) becomes a flat terrace - never a pit. Between it and the wall the land lies 5-6 below the base level (a gully at x -460..-452): future fill, not a building site yet |

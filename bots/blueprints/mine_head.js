// mine_head: THE MINE ENTRANCE on the surface - a level pad, a roofed hut (mob-proof rest between shifts), chests for the haul and the tools, a bed
...
module.exports = (o, p = {}) => {
  ...
  const furn = { '-4,-2': { block: 'chest', cat: 'ores', half: 0 }, '-4,-1': { block: 'chest', cat: 'ores', half: 1 }, '-4,1': { block: 'chest', cat: 'tools' }, '-2,-2': { block: 'chest', cat: 'food' } }

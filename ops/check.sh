...
for f in skills/army_worker.js skills/iron_miner.js skills/lib/*.js skills/core/index.js army/dispatcher.js army/armyctl.js metrics/inspector.js manager.js blueprints/*.js; do node --check "$f" 2>/dev/null || { echo "SYNTAX  $f"; bad=1; }; done
